...
public class OI {
    ...
    public OI() {
        ...
        rightClick.whenPressed(new MoveElevatorToPositionCommand(RobotMap.ELEVATOR_POSITION_1,5.0));
        leftClick.whenPressed(new MoveElevatorToPositionCommand(RobotMap.ELEVATOR_POSITION_2,5.0));
